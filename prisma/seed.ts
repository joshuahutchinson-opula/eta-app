...
async function main() {
  ...
  const pushCart = await prisma.vendor.create({
    data: {
      ...
      videos: [
        ...
        'https://res.cloudinary.com/wspvflyn/video/upload/v1789881231/vendors/pushcart-restaurant-rum-bar/aozlitt8wtpx8oerxlou.mp4',
        'https://res.cloudinary.com/wspvflyn/video/upload/v1789881233/vendors/pushcart-restaurant-rum-bar/kzpduypbi8fuwscqxdvq.mp4',
      ],
      open: true,
      live: true,
      isPremium: true,
  ...
  const coralReef = await prisma.vendor.create({
    data: {
      ...
      videos: [
        'https://res.cloudinary.com/wspvflyn/video/upload/v1789881173/vendors/bourbon-beach/n0u8jxf9owabrc4y7xbu.mp4',
        'https://res.cloudinary.com/wspvflyn/video/upload/v1789881175/vendors/bourbon-beach/hftv3pxculahgpa4qpg2.mp4',
      ],
      open: true,
      live: true,
      isPremium: false,
  ...
  const islandWellness = await prisma.vendor.create({
    data: {
      ...
      videos: [
        'https://res.cloudinary.com/wspvflyn/video/upload/v1789881113/vendors/ocean-view-spa/qg1zi1lcmkbpwwat3pjr.mp4',
        'https://res.cloudinary.com/wspvflyn/video/upload/v1789881116/vendors/ocean-view-spa/t8b9gleykwynvsm92qhg.mp4',
        'https://res.cloudinary.com/wspvflyn/video/upload/v1789881119/vendors/ocean-view-spa/e03vdsvixlbwybm3d2dy.mp4',
      ],
      open: true,
      live: true,
      isPremium: false,
  ...
  const cliffsideGrill = await prisma.vendor.create({
    data: {
      ...
      videos: [
        'https://res.cloudinary.com/wspvflyn/video/upload/v1789881139/vendors/ivan-s-bar-restaurant/hf2kxi63evzpv4ktbo6n.mp4',
        'https://res.cloudinary.com/wspvflyn/video/upload/v1789881143/vendors/ivan-s-bar-restaurant/ay7xvktxp38dyg5iu27o.mp4',
        'https://res.cloudinary.com/wspvflyn/video/upload/v1789881146/vendors/ivan-s-bar-restaurant/ncr2z8wj3gpvl9yszw7d.mp4',
      ],
      open: true,
      live: false,
      isPremium: true,
  ...
  const rockhouseRestaurant = await prisma.vendor.create({
    data: {
      ...
      videos: [
        ...
        'https://res.cloudinary.com/wspvflyn/video/upload/v1789881191/vendors/rockhouse-restaurant/dfqahaivhphvvyxcilas.mp4',
        'https://res.cloudinary.com/wspvflyn/video/upload/v1789881196/vendors/rockhouse-restaurant/qkc51vvkawy32nmvarym.mp4',
      ],
      open: true,
      live: false,
      isPremium: false,
  ...
  const sweetSpice = await prisma.vendor.create({
    data: {
      ...
      videos: [
        'https://res.cloudinary.com/wspvflyn/video/upload/v1789881200/vendors/sweet-spice-restaurant/ewmjso8s3uc7c3359ryv.mp4',
        'https://res.cloudinary.com/wspvflyn/video/upload/v1789881203/vendors/sweet-spice-restaurant/hkivpj9cktuq5hprwg5c.mp4',
        'https://res.cloudinary.com/wspvflyn/video/upload/v1789881207/vendors/sweet-spice-restaurant/xhl8r7qks5a5jtrwobqs.mp4',
      ],
      open: true,
      live: false,
      isPremium: false,
  ...
  const koolVybes = await prisma.vendor.create({
    data: {
      ...
      videos: [
        'https://res.cloudinary.com/wspvflyn/video/upload/v1789881107/vendors/kool-vybes-bar-jerk-center/hffpbwkmwvy8luxtsiti.mp4',
      ],
      open: true,
      live: false,
      isPremium: false,
  ...
  const bestInTheWest = await prisma.vendor.create({
    data: {
      ...
      videos: [
        'https://res.cloudinary.com/wspvflyn/video/upload/v1789881102/vendors/best-in-the-west-jerk-centre/mhire5rzcd8hugva7sru.mp4',
      ],
      open: true,
      live: false,
      isPremium: false,
  ...
  const momsPlace = await prisma.vendor.create({
    data: {
      ...
      videos: [
        'https://res.cloudinary.com/wspvflyn/video/upload/v1789881252/vendors/mom-s-place/ixvvlfuvn3cc4yrmu6kq.mp4',
      ],
      open: true,
      live: false,
      isPremium: false,
  ...
  const alfredsOceanPalace = await prisma.vendor.create({
    data: {
      ...
      videos: [
        'https://res.cloudinary.com/wspvflyn/video/upload/v1789881090/vendors/alfred-s-ocean-palace/adse4imhhgzn4d5c1h35.mp4',
        'https://res.cloudinary.com/wspvflyn/video/upload/v1789881093/vendors/alfred-s-ocean-palace/ie151czkjz9x9mku0xb5.mp4',
        'https://res.cloudinary.com/wspvflyn/video/upload/v1789881096/vendors/alfred-s-ocean-palace/tphzz4cxxypbzvngy6pe.mp4',
      ],
      open: true,
      live: false,
      isPremium: false,
  ...
  const oneLoveBusCrawl = await prisma.vendor.create({
    data: {
      ...
      videos: [
        'https://res.cloudinary.com/wspvflyn/video/upload/v1789881258/vendors/one-love-bus-bar-crawl/xo1wt6ekdpd8e3numw6n.mp4',
      ],
      open: true,
      live: false,
      isPremium: false,
  ...
  const woodstockBar = await prisma.vendor.create({
    data: {
      ...
      videos: [
        'https://res.cloudinary.com/wspvflyn/video/upload/v1789881279/vendors/woodstock/zutek6asxbztb8dbd37o.mp4',
        'https://res.cloudinary.com/wspvflyn/video/upload/v1789881282/vendors/woodstock/bw662e9741j28unxysrj.mp4',
        'https://res.cloudinary.com/wspvflyn/video/upload/v1789881286/vendors/woodstock/ig1sehzvrmynh4ttyrnd.mp4',
      ],
      open: true,
      live: false,
      isPremium: false,
  ...
  const negrilHillsGolf = await prisma.vendor.create({
    data: {
      ...
      videos: [
        'https://res.cloudinary.com/wspvflyn/video/upload/v1789881166/vendors/negril-hills-golf-club/kgnbhhljkfre4oqs8vcx.mp4',
        'https://res.cloudinary.com/wspvflyn/video/upload/v1789881170/vendors/negril-hills-golf-club/px5zojba50rhuyg8v4jk.mp4',
      ],
      open: true,
      live: false,
      isPremium: false,
